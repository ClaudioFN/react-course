            ...
            <> 
                <Navbar dark expand="md">
                    ...
                    <NavbarBrand className="mr-auto" href="/">
                        ...
                        <img src="assets/images/logo.png" height="30" width="41" alt="That Restaurant Again!" />
                    </NavbarBrand>
                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                <h1>That Restaurant Again!</h1>
                                <p>This is another app but now with React instead of AngularJS!</p>
                            </div>
                        </div>
                    </div>
                </Jumbotron>

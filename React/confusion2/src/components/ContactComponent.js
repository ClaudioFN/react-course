...
import { Breadcrumb, BreadcrumbItem, Button, Form, FormGroup, Label, Input, Card, Col, Row, FormFeedback } from 'reactstrap';
...
class Contact extends Component{
    ...
    //        errors.firstname = 'First Name Should Be Greater Than 3 Caracters';
    //    else if (this.state.touched.firstname && firstname.length > 10)
    //        errors.firstname = 'First Name Should Be Inferior Than 10 Caracters';

    //    if (this.state.touched.lastname && lastname.length < 3)
    //        errors.lastname = 'Last Name Should Be Greater Than 3 Caracters';
    //    else if (this.state.touched.lastname && lastname.length > 10)
    //        errors.lastname = 'Last Name Should Be Inferior Than 10 Caracters';
            ...
            <div className="container">
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                            ...
                            <address>
                            121, RUA QUALQUER<br />
                            BAIRRO QUALQUER, CIDADE QUALQUER<br />
                            PAIS QUALQUER<br />
                            ...
                            <Row className='form-group'>
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors className='text-danger' model='.firstname' show='touched' messages={{
                                        ...
                                        maxLength: 'First Name must be inferior than 15 characters!'
                                    }}></Errors>
                                </Col>
                            </Row>
                            <Row className='form-group'>
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors className='text-danger' model='.lastname' show='touched' messages={{
                                        ...
                                        maxLength: 'Last Name must be inferior than 15 characters!'
                                    }}></Errors>
                                </Col>
                            </Row>
                            <Row className='form-group'>
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors className='text-danger' model='.telnum' show='touched' messages={{
                                        required: 'Required - ',
                                        minLength: 'Contact must be greater than 2 numbers!',
                                        maxLength: 'Contact must be inferior than 15 numbers!',
                                        isNumber: 'Contact must be only number!'
                                    }}></Errors>
                                </Col>
                            </Row>
                            <Row className='form-group'>
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors className='text-danger' model='.telnum' show='touched' messages={{
                                        required: 'Required - ',
                                        validEmail: 'Email invalid address!'
                                    }}></Errors>
                                </Col>
                            </Row>
                            <Row className='form-group'>
                                <Col md={{size:6, offset: 2}}>
                                    <div className='form-check'>
                                        <Label check>
                                            <Control.checkbox model='.agreed' className='form-check-iput' name='agree'  /> {' '} 
